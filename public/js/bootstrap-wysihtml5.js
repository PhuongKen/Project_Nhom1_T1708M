    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                ...
                "<a class='btn btn-default" + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class=\"fas fa-outdent\"></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
              "</div>" +
              "<a class='btn btn-default" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class=\"fas fa-share-square\"></i></a>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
              "</div>" +
              "<a class='btn btn-default" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class=\"far fa-image\"></i></a>" +
            "</li>";
        },
